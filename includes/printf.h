...
void						get_res_u_c(t_printf **f, va_list ap,
	unsigned long long int *res);
void						get_res_u(t_printf **f, va_list ap,
	unsigned long long int *res);
void						get_result(t_printf **f, va_list ap,
	long long int *res);
char						*s_r_m(t_printf **factor, char *s_r,
	long long int res);
void						m_w(t_printf **f, char **w, char	**res);
int							ft_nbrlen_u(unsigned long long int n, int base);
char						*ft_strrev_u(char *str);
char						*fill_str_u(char *str, unsigned
	long long int nb, int i);
char						*ft_itoa_u(unsigned long long int n);
int							nb_size_u(unsigned long long int nb);
char						*ft_itoa_base_u(unsigned
	long long int n, int base, int uppercase);
...
char						*ft_float_itoa(long long int frac,
	long long int exp, int precision);
long long int				ft_modf(long double res, int pr,
	long long int *res_int);
char						*first_char(t_printf **f,
	char **width, long long int res);
char						*manage_int_w(t_printf **f,
	char *pr, long long int value);
char						*manage_pr(t_printf **f,
	char *pr, long long int value);
char						*manage_w(t_printf **f, char *w, char **res);
char						*manage_res(t_printf **f, char **w,
	char **pr, long long int res);
char						*ft_float(t_printf **factor, va_list ap);
void						allocate(t_printf **f, char **precision,
	char **width, long long int *res);
...
void						init(t_printf **factor,
const char *restrict format);
void						check_specifier(t_printf **factor, int *i);
int							check_width(t_printf **factor, int *i,
	va_list ap);
void						check_precision(t_printf **factor,
	int *i, va_list ap);
