...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/07 04:09:10 by sgusache          #+#    #+#             */
/*   Updated: 2019/07/07 04:57:08 by sgusache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const unsigned int	g_sha[64] = {
...
void					sha256_update(t_ssl *ctx, const unsigned char data[],
						size_t len);
void					sha256_transform(t_ssl *ctx,
...
int						check_f(t_ssl **ssl, char *str, char **arg,
						int position);
